...
log ""
log_color "$YELLOW" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
log_color "$YELLOW" "EXTERNAL SERVICES:"
log_color "$YELLOW" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

# Plex (external server)
if test_api "Plex" "plex_token.txt" "${PLEX_URL:-http://192.168.4.47:32400}" "/status/sessions" "?X-Plex-Token="; then
    ((PASSED++))
else
    ((FAILED++))
fi
